...
<body>
    <div class="container">
        ...
        <table class="table">
            ...
            <tr class="table-row">
                <td class="table-cell">MR EPHRAIM</td>
                <td class="table-cell-email">nob@iie.edu.za</td>
                <td class="table-cell">ICT</td>
            </tr>
            <tr class="table-row">
            ...
            <tr class="table-row">
                <td class="table-cell">MRS LEGODI</td>
                <td class="table-cell-email">legodi@iie.edu.za</td>
