...
<header id="header">
        ...
        <div class="header-content">
            <div class="header-user">
                <span class="username">John  Q-Tap</span>
            </div>
        </div>
    </header>
<nav id="navbar">
  <ul class="navbar-items flexbox-col">
	...
	<script>
        ...
        function navigateBookNow() {
            ...
            window.location.href = "STUDENT FORM FOR BOOKINGS.php";
        }
		
		function navigateCompain() {
            // You can add navigation logic here, for example:
            window.location.href = "Lodge Complain.php";
        }
		...
		function navigateWorkerForce() {
            // You can add navigation logic here, for example:
            window.location.href = "WorkerForce.php";
        }
    </script>
	<script>
...
<main id="main" class="flexbox-col">
        ...
        <div class="dashboard-item">
			...
			<br/>
            <p>Book a session with a lecturer.</p>
			<br/>
            <button class="custom-button" href="STUDENT FORM FOR BOOKINGS.php" onclick="navigateBookNow()">Book Now</button>
        </div>
		<div class="dashboard-item">
            <h3>Lodge Complain</h3>
			<br/>
            <p>Lodge Complain or Query about something.</p>
			<br/>
            <button class="custom-button" href="STUDENT FORM FOR BOOKINGS.php" onclick="navigateCompain()">Lodge Complain</button>
        </div>
        <div class="dashboard-item">
        ...
        <div class="dashboard-item">
            <h3>Rosebank collage Workers</h3>
			<br/>
            <p>Workers of Rosebank.</p>
			<br/>
            <button class="custom-button" href="contact_lecturer.php"  onclick="navigateWorkerForce()">Work Force</button>
        </div>
    </div>
        </div>
  ...
  .custom-button {
	...
	var user = localStorage.getItem('myValue');
        if (user != null) {
			...
			window.history.back(); // Go back to the previous page
			window.location.href = "Login.php";
            console.log("User Your Not Sign in");
            // Example: Show a "Sign In" button and hide the "Sign Out" button
            document.getElementById("signOutButton").style.display = "none";
            document.getElementById("signInButton").style.display = "block";
        }
